...
// Vérifier les permissions pour accéder au dashboard
requireAccess($conn, $_SESSION['admin_id'], 'dashboard');
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-slide-up">
    ...
    <div class="dashboard-card card-purple animate-fade-in">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-600 text-sm font-medium mb-1">Total des réservations</p>
                <p class="text-3xl font-bold text-gray-900"><?= htmlspecialchars($reservations) ?></p>
    ...
    <div class="dashboard-card card-orange animate-fade-in" style="animation-delay: 0.1s;">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-600 text-sm font-medium mb-1">Plats au menu</p>
                <p class="text-3xl font-bold text-gray-900"><?= htmlspecialchars($plats) ?></p>
    ...
    <div class="dashboard-card card-green animate-fade-in" style="animation-delay: 0.2s;">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900"><?= number_format($revenus, 0, ',', ' ') ?></p>
                <p class="text-xs text-gray-600 mt-1">FCFA</p>
            </div>
    ...
    <div class="dashboard-card card-blue animate-fade-in" style="animation-delay: 0.3s;">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-600 text-sm font-medium mb-1">Taux confirmation</p>
                <p class="text-3xl font-bold text-gray-900"><?= $taux_confirmation ?>%</p>
