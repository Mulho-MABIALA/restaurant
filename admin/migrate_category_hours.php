<?php
/**
 * Script de migration pour ajouter les horaires de disponibilité aux catégories
...
try {
    ...
    if ($stmt->rowCount() > 0) {
        $message = "✅ Les colonnes existent déjà. Migration non nécessaire.";
        $success = true;
    } else {
        ...
        $message = "✅ Migration réussie ! Les colonnes heure_debut, heure_fin et disponibilite_active ont été ajoutées à la table categories.";
        $success = true;
    }
...
<head>
    ...
    <title>Migration - Horaires Catégories</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-xl p-8 max-w-2xl w-full">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-600">Ajout des horaires de disponibilité aux catégories</p>
            </div>
            ...
            <div class="space-y-4 mb-6">
                <h2 class="font-bold text-gray-800 text-xl">📋 Colonnes ajoutées:</h2>
                <ul class="space-y-2 text-gray-700">
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                        <div>
                            <strong>heure_debut</strong> (TIME) - Heure de début de disponibilité
                        </div>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                        <div>
                            <strong>heure_fin</strong> (TIME) - Heure de fin de disponibilité
                        </div>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                        <div>
                            <strong>disponibilite_active</strong> (TINYINT) - Active ou désactive les horaires
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg mb-6">
                ...
                <ol class="list-decimal list-inside space-y-1 text-blue-700 text-sm">
                    <li>Allez dans <strong>Catégories de Plats</strong></li>
                    <li>Configurez les horaires pour chaque catégorie (ex: Brunch 10h-15h)</li>
                    <li>Les catégories seront automatiquement bloquées en dehors des horaires</li>
                </ol>
            </div>
            <?php endif; ?>

            <div class="flex flex-col sm:flex-row gap-3">
                <a href="categories_plats.php" class="flex-1 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-3 rounded-xl font-semibold text-center hover:shadow-lg transition-all">
